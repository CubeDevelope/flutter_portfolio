          ...
          onPressed: () {
            if (_titleController.text.isNotEmpty &&
              ...
              final newTransaction = Transaction(
                titleOfTransaction: _titleController.text,
                amountOfTransaction: double.parse(_amountController.text),
              );

              p0.addTransaction(newTransaction);
        ...
        return Padding(
          ...
          child: Column(
            children: [
              ...
              _buildInputField(
                  _amountController, "Valore della transazione in €", type: TextInputType.number),
